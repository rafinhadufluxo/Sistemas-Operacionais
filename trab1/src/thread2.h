...
//   unsigned long i,j;
//   if(pthread_mutex_trylock(&mutex2)==0){ /*here return zero if a lock on the mutex object referenced by the mutex is acquired. Otherwise, an error number is returned to indicate the error.*/ 
